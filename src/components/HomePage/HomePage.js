      ...
      <Container className="sr-steel-features-container py-5 text-center">
        ...
        <Row className="align-items-center py-5">
          ...
          <Col md={4}>
            ...
            <Image src={img3} className="sr-steel-Furniture-full" />
          </Col>

          {/* Center Column (Text) */}
          <Col md={4} className="text-center sr-steel-Furniture-text-col">
            <Image src={img2} className="sr-steel-Furniture-half11" />
          ...
          <Col md={4}>
            ...
            <div className="d-flex gap-2">
              <Image src={img6} className="sr-steel-Furniture-half" />
            </div>
          </Col>
        </Row>
        ...
        <Row>
          <Col md={6} className="mb-4 sr-steel-Mediocrity-left-img">
            <Image src={door4} alt="Main Door" fluid />
          </Col>
          <Col md={6}>
            <Row>
